...
// Multi-Year composite for 2000-2003
function getLandsatComposite(area) {
  var startDate = ee.Date('2000-05-01');
...
// Calculate pectral indices and texture
...
// DMSP-OLS as replacement for NTL
...
// Select SWIR1 band and scale to int16 for GLCM texture analysis
...
// Sample image with training data
...
// 2. Reclassify Cropland and Built-Up as Barren within PAs (excluding Mgahinga)
